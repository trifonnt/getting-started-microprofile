package ws.ament.microprofile.gettingstarted.service;
...
import ws.ament.microprofile.gettingstarted.model.Author;
...
public class AuthorService {
	...
	public Author findAuthor(String id) {
		Author author = ClientBuilder.newClient()
				...
				.request(MediaType.APPLICATION_JSON).get(Author.class);
